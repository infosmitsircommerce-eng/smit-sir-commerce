...
export const seoMaterials = [
  ...
  makeMaterial({
    ...
    gscTitle: 'Business Environment Class 12 Notes PDF (Chapter 3)',
    gscDescription: 'Download free CBSE Business Environment Class 12 notes PDF for Chapter 3, with dimensions, importance, LPG reforms, questions and MCQs.',
  ...
  makeMaterial({
    ...
    gscTitle: 'Controlling Class 12 Notes PDF | CBSE Business Studies',
    gscDescription: 'Download free Controlling Class 12 notes PDF for CBSE Business Studies Chapter 8, including the process, planning relationship, questions and MCQs.',
