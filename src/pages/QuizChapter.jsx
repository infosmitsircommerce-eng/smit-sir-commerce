...
export default function QuizChapter() {
  ...
  return <main className="page-container py-10 max-w-5xl">
    ...
    <a className="btn-secondary inline-flex mt-4" href={'https://wa.me/?text='+encodeURIComponent('Practise '+page.title+' with free Easy and Moderate questions: '+base+page.path)} target="_blank" rel="noopener noreferrer">Share this chapter quiz</a>
