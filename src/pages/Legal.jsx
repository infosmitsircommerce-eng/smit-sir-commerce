...
const documents = {
  '/privacy': {
    ...
    sections: [
      ...
      ['Analytics', 'The platform may record limited product-usage events such as page views, exam starts, exam completions and admission-form funnel events to understand which learning and enquiry flows are useful. Analytics metadata is designed not to include passwords, phone numbers, email addresses or free-text student answers.'],
      ['Third-party services', 'Hosting, authentication, database, storage and related infrastructure may be provided by services such as Vercel and Supabase. Optional calendar actions can open a calendar provider with the demo time and basic booking details when the owner chooses to use them. Their own privacy and security terms also apply to data processed by those services.'],
      ['Your controls', 'Students can use the My Data page to export supported device-saved study progress, restore a backup and clear supported local study data. Account, cloud-data or enquiry-data deletion requests can be made through the contact page.'],
      ...
      ['Contact', 'Questions about privacy, account data or admission-enquiry data can be sent through the website contact page.'],
    ],
  },
  '/terms': {
    title: 'Terms of Use',
