      ...
      },
      {
        ...
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "Home", item: `${BASE}/` },
          {
            ...
            item: `${BASE}/commerce-coaching-mehsana`,
          },
          {
            "@type": "ListItem",
            position: 3,
...
function buildDemoHref(page) {
  ...
  else if (page.path.includes("cbse") || page.path.includes("class-"))
  ...
  if (page.path.includes("business-studies"))
    params.set("subject", "Business Studies");
...
export default function LocalSeoLanding() {
  ...
  const freeResourceHref = isGseb
    ? "/gseb-class-12-economics.html"
    : "/cbse-notes";
  const freeResourceLabel = isGseb
    ? "Free GSEB Economics notes"
    : "Free CBSE notes";
  const defaults = {
    board: isGseb ? "GSEB" : "CBSE",
    classLevel: page.path.includes("class-11") ? 11 : 12,
    subject: page.path.includes("business-studies")
      ? "Business Studies"
      : "Economics",
    studyMode: "Offline",
  };
    ...
    <div className="min-h-screen" style={{ background: "var(--bg-ivory)" }}>
      ...
      <section className="page-hero">
        <div className="page-container">
          ...
          >
            <Link to="/">Home</Link>
            <span>/</span>
            <Link to="/commerce-coaching-mehsana">
              Commerce coaching in Mehsana
            </Link>
            <span>/</span>
            <span style={{ color: "var(--gold)" }}>{page.h1}</span>
          </nav>

          <div className="grid lg:grid-cols-[minmax(0,1fr)_340px] gap-8 items-start">
            <div>
              <span className="eyebrow inline-flex items-center gap-2">
                <MapPin className="w-4 h-4" /> {page.eyebrow}
              </span>
              ...
              <div className="flex flex-wrap gap-3 mt-7">
                ...
                >
                  <BookOpen className="w-4 h-4" /> {freeResourceLabel}
                </Link>
              </div>
            </div>
            ...
            <aside className="card-paper p-6">
              ...
              >
                Local Commerce support in Mehsana
              </h2>
              <p
                className="text-sm leading-7 mt-3"
                style={{ color: "var(--muted)" }}
              >
                Use the free resources first, understand the teaching approach,
                then request a demo before deciding on a batch.
              </p>
              <Link
                to="/commerce-coaching-mehsana"
                className="inline-flex items-center gap-2 text-sm font-semibold mt-5"
                style={{ color: "var(--gold)" }}
              >
                View complete Mehsana coaching page{" "}
      ...
      <main className="page-container section-padding space-y-8">
        ...
        >
          <div className="card-paper p-5 sm:p-7">
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
            >
              Know exactly where marks are being lost
            </h2>
            <p className="leading-7 mt-4" style={{ color: "var(--muted)" }}>
              Bring one recent school or tuition paper. Smit Sir will identify
              the mistake pattern, the weak chapter and the first improvement
              step. You can then decide whether the teaching support fits you.
            </p>
            <div className="space-y-3 mt-5 text-sm">
              {[
                "No payment for the analysis",
                "No admission commitment",
                "Student and parent can discuss the plan",
              ].map((item) => (
                <div
                  key={item}
          ...
          <div className="card-paper p-5 sm:p-7">
            <LeadCaptureForm
              ...
              defaults={defaults}
              landingContextOverride={page.path.replace(/^\//, "")}
            />
          </div>
        </section>
        ...
        <section className="card-paper p-5 sm:p-7 md:p-9">
          ...
          <p
            className="leading-8 mt-4 max-w-4xl"
            style={{ color: "var(--muted)" }}
          >
            {page.sectionText}
          </p>
        ...
        <section className="grid lg:grid-cols-[1.1fr_.9fr] gap-6">
          <div className="card-paper p-5 sm:p-7 md:p-9">
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
            >
              See the material, try the teaching approach, then decide
            </h2>
            <div className="space-y-4 mt-6">
              {[
                [
                  ...
                  "Use the published notes and practice pages to understand the style and depth of the learning material.",
                ],
                [
                  "2",
                  "Request a demo class",
                  "A student and parent can understand the teaching approach before making a batch decision.",
                ],
                [
                  "3",
                  "Build a revision routine",
                  "Combine class learning with chapter practice, tests and repeated revision on the website.",
                ],
              ].map(([n, title, text]) => (
                <div key={n} className="tile-paper p-4 flex gap-4">
                  <span
                    className="w-9 h-9 rounded-full flex-shrink-0 inline-flex items-center justify-center font-bold"
                    style={{
                  ...
                  <div>
                    ...
                    <p
                      className="text-sm leading-7 mt-1"
                      style={{ color: "var(--muted)" }}
                    >
                      {text}
                    </p>
          ...
          <div className="card-paper p-5 sm:p-7 md:p-9">
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
            >
              Continue your Commerce preparation
            </h2>
            <div className="space-y-3 mt-6">
              ...
              <Link
                ...
                className="tile-paper p-4 flex items-center justify-between gap-3 font-semibold text-sm"
              >
                <span>Contact Smit Sir Commerce</span>
                <ArrowRight
                  className="w-4 h-4"
                  style={{ color: "var(--gold)" }}
                />
              ...
              <Link
                to="/mehsana-commerce-student-resources.html"
                className="tile-paper p-4 flex items-center justify-between gap-3 font-semibold text-sm"
              >
                <span>Mehsana student resources</span>
                <ArrowRight
                  className="w-4 h-4"
                  style={{ color: "var(--gold)" }}
                />
        ...
        <section className="card-paper p-5 sm:p-7 md:p-9">
          ...
          <h2
            ...
            style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
          >
            Explore related tuition options in Mehsana
          </h2>
        ...
        <section className="card-paper p-6 sm:p-8 md:p-10 text-center">
          ...
          <h2
            ...
            style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
          >
            Want to see whether the teaching style suits you?
          </h2>
          <p
            className="mt-3 max-w-2xl mx-auto"
            style={{ color: "var(--muted)" }}
          >
            Start with the free resources or request a demo class before
            choosing a Commerce batch.
          </p>
          <Link
            to={demoHref}
