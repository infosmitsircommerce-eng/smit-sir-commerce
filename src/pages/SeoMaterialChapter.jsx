...
import {
  ...
  getMaterialFaqs,
  getMaterialStructuredData,
  materialByPath,
  hubByPath,
  seoHubs,
} from "../data/seoMaterials";
...
function ChapterNotFound({ pathname }) {
  return (
    ...
    >
      <SEO
        title="Chapter Notes Not Found"
        description="The requested chapter notes could not be found."
        path={pathname}
        noindex
      />
...
export default function SeoMaterialChapter() {
  ...
  const quizPage =
    material.class_level === 11 && material.hubId?.includes("micro")
      ? quizPageById[`cbse-11-micro-ch${material.chapterNumber}`]
      : null;
      ...
      <section className="page-hero">
        <div className="page-container">
          <nav
            ...
            className="text-sm mb-7 flex flex-wrap items-center gap-2"
          ...
          >
            ...
            <span style={{ color: "var(--gold)" }}>
              Chapter {material.chapterNumber}
            </span>
          </nav>
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-9 items-start">
            <div>
              <span className="eyebrow">
                Free CBSE Class {material.class_level} notes
              </span>
              <h1 className="mt-5">
                {material.gscH1 || (
                  <>
                    {material.chapter} <em>Notes PDF</em>
                  </>
                )}
              </h1>
              <p
                ...
                style={{ color: "var(--muted)" }}
              >
                {material.gscIntro || material.summary}
              </p>
              <div className="grid grid-cols-1 sm:flex gap-3 mt-7">
                ...
                >
                  <Eye className="w-4 h-4" /> View PDF online
                </Link>
                <a
            ...
            <aside className="card-paper p-5 sm:p-6">
              ...
              <dl className="space-y-3 text-sm">
                <div className="flex justify-between gap-3">
                  <dt style={{ color: "var(--muted)" }}>Board</dt>
                  <dd className="font-semibold" style={{ color: "var(--ink)" }}>
                    CBSE
                  </dd>
                </div>
                <div className="flex justify-between gap-3">
                  <dt style={{ color: "var(--muted)" }}>Class</dt>
                  <dd className="font-semibold" style={{ color: "var(--ink)" }}>
                    {material.class_level}
                  </dd>
                </div>
                <div className="flex justify-between gap-3">
                  <dt style={{ color: "var(--muted)" }}>Subject</dt>
                  <dd
                ...
                <div className="flex justify-between gap-3">
                  <dt style={{ color: "var(--muted)" }}>Length</dt>
                  <dd className="font-semibold" style={{ color: "var(--ink)" }}>
          ...
          <div className="space-y-7">
            ...
            <section className="card-paper p-5 sm:p-7 md:p-9">
              ...
              <p className="leading-8" style={{ color: "var(--muted)" }}>
                {material.summary} The material is organised for students who
                want a clear first reading as well as quick revision before
                school tests and CBSE examinations. Definitions, relationships
                and application points should be learned with their supporting
                examples rather than memorised in isolation.
              </p>
            </section>
            ...
            <section className="card-paper p-5 sm:p-7 md:p-9">
              <h2
                ...
                style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
              >
                Why you can trust this study resource
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="tile-paper p-4">
                  ...
                  <p
                    ...
                    style={{ color: "var(--muted)" }}
                  >
                    Organised by Smit Sir for Class {material.class_level}{" "}
                    Commerce students.
                  </p>
                </div>
                <div className="tile-paper p-4">
                  ...
                  <p
                    ...
                    style={{ color: "var(--muted)" }}
                  >
                    Topics, questions and MCQs focus only on {material.chapter}.
                  </p>
                </div>
                <div className="tile-paper p-4">
                  <strong
                  ...
                  <p
                    ...
                    style={{ color: "var(--muted)" }}
                  >
                    Free to view and download with no account required.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="card-paper p-5 sm:p-7 md:p-9">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {material.keyTopics.map((topic) => (
                  <div
                    key={topic}
                    className="tile-paper p-4 flex items-start gap-3"
                  >
                    <CheckCircle2
            ...
            {quizPage && (
              <section className="card-paper p-6">
                <h2 className="text-2xl mb-3">Practise this chapter</h2>
                <Link to={quizPage.path} className="btn-primary inline-flex">
                  {quizPage.title} — start free
                </Link>
              </section>
            )}
            {chapterPractice.length > 0 && (
              <section
                className="card-paper p-5 sm:p-7 md:p-9"
                aria-labelledby="chapter-practice-heading"
              >
                <span className="eyebrow">Next step</span>
                <h2
                  id="chapter-practice-heading"
                ...
                >
                  Now practise {material.chapter}
                </h2>
                <p className="leading-7 mb-6" style={{ color: "var(--muted)" }}>
                  Reading is step one. Use these chapter-specific pages to
                  retrieve the concepts, apply them and find what still needs
                  revision.
                </p>
                <div className="grid sm:grid-cols-2 gap-3">
                  {chapterPractice.map((item) => (
                    <Link
                      key={item.path}
                      to={item.path}
              ...
              >
                {faqs.map((faq) => (
                  <details key={faq.question} className="py-4 group">
                    <summary
                      className="cursor-pointer font-semibold list-none flex justify-between gap-4"
                      style={{ color: "var(--ink)" }}
                    >
                      {faq.question}
                    ...
                    <p
                      className="mt-3 leading-relaxed pr-8"
                      style={{ color: "var(--muted)" }}
                    >
                      {faq.answer}
                    </p>
          ...
          <aside className="space-y-5 lg:sticky lg:top-24">
            <div className="card-paper p-6">
              ...
              <p
                ...
                style={{ color: "var(--muted)" }}
              >
                Teacher for Economics, Business Studies and Entrepreneurship for
                Classes 11 and 12. Accountancy content on this website is
                provided as learning resources and calculators.
              </p>
              <Link
                to="/about"
                ...
                style={{ color: "var(--gold)" }}
              >
                About the teacher <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
            {chapterPractice.length > 0 && (
              <div className="card-paper p-6">
                ...
                <div className="space-y-3">
                  {chapterPractice.slice(0, 5).map((item) => (
                    <Link
                      key={item.path}
                      to={item.path}
                      className="tile-paper p-3 flex items-center justify-between gap-3 text-sm"
                    >
                      <span>{item.label}</span>
                      <ArrowRight
                        className="w-4 h-4 flex-shrink-0"
            ...
            <div className="card-paper p-6">
              ...
              <div className="space-y-3">
                {previous && (
                  <Link
                    to={previous.seo_path}
                    className="tile-paper p-3 flex items-center gap-3 text-sm"
                  >
                    <ArrowLeft
                      className="w-4 h-4"
                      style={{ color: "var(--gold)" }}
                    />
                    <span>
                      Chapter {previous.chapterNumber}: {previous.chapter}
                    </span>
                  </Link>
                )}
                {next && (
                  ...
                  >
                    <span>
                      Chapter {next.chapterNumber}: {next.chapter}
                    </span>
                    <ArrowRight
                      className="w-4 h-4 flex-shrink-0"
                      style={{ color: "var(--gold)" }}
              ...
              <div className="space-y-3">
                {relatedHubs.map((related) => (
                  <Link
                    ...
                    className="tile-paper p-3 flex items-center justify-between gap-3 text-sm"
                  >
                    <span>Free {related.label} notes</span>
                    <ArrowRight
                      className="w-4 h-4 flex-shrink-0"
                      style={{ color: "var(--gold)" }}
                    />
