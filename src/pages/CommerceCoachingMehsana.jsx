...
const subjects = [
  [
    "Economics",
    "Concept clarity, diagrams, numericals, application questions and exam-focused revision.",
  ],
  [
    "Business Studies",
    "Chapter-wise explanation, case studies, important questions and answer-writing practice.",
  ],
  [
    "Entrepreneurship",
    "Clear concepts, practical examples, application-based questions and revision support.",
  ],
  [
    "Physical Education",
    "Simple explanations, structured theory revision and exam-oriented preparation.",
  ],
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Smit Sir personally teaches Economics, Business Studies, Entrepreneurship and Physical Education for Class 11 and 12 students.",
  },
  {
    question: "Are Accountancy resources available?",
    answer:
      "Yes. The website provides free Accountancy calculators and learning resources as separate study support. Accountancy is not presented as a personal tuition subject.",
  },
  {
    question: "Can I take a demo class before joining?",
    answer:
      "Yes. Students and parents can request a free paper analysis or demo before deciding on a batch. There is no admission commitment just to try the teaching approach.",
  },
  {
    question: "Are free Commerce notes and tools available?",
    answer:
      "Yes. Smit Sir Commerce publishes free chapter-wise notes, practice resources and Commerce calculators that students can use independently of tuition.",
  },
];
  ...
  "@graph": [
    {
      ...
      description:
        "Class 11 and 12 Commerce coaching in Mehsana with CBSE Commerce support, GSEB Economics revision, Economics, Business Studies and Entrepreneurship teaching, plus free notes, tools and demo support.",
      inLanguage: "en-IN",
    ...
    },
    {
      ...
      offers: {
        ...
        url: `${BASE}/book-demo`,
        description:
          "Request a free paper analysis and demo before choosing a batch.",
      },
    },
    {
      "@type": "FAQPage",
    ...
    },
    {
      ...
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Home", item: `${BASE}/` },
        {
          "@type": "ListItem",
          position: 2,
          name: "Commerce Coaching in Mehsana",
          item: `${BASE}${PATH}`,
        },
      ],
    },
    ...
    <div className="min-h-screen" style={{ background: "var(--bg-ivory)" }}>
      ...
      <section className="page-hero">
        <div className="page-container">
          <nav
            ...
            className="text-sm mb-7 flex items-center gap-2"
            style={{ color: "var(--muted)" }}
          >
            <Link to="/">Home</Link>
            <span>/</span>
            <span style={{ color: "var(--gold)" }}>
              Commerce Coaching in Mehsana
            </span>
          </nav>
          ...
          <div className="grid lg:grid-cols-[minmax(0,1fr)_360px] gap-9 items-start">
            <div>
              ...
              <div className="flex flex-wrap gap-3 mt-7">
                ...
                >
                  Ask about tuition / free demo <ArrowRight className="w-4 h-4" />
                </Link>
                <Link
                  to="/cbse-notes"
              ...
              >
                {[
                  ...
                  <span key={item} className="tile-paper px-3 py-2">
                    {item}
                  </span>
                ))}
              </div>
            ...
            <aside className="card-paper p-6 sm:p-7">
              ...
              >
                Try the learning approach first
              </h2>
              <p
                className="text-sm leading-7 mt-3"
                style={{ color: "var(--muted)" }}
              >
                Bring a recent test paper, identify where marks were lost and
                experience the teaching approach before making an admission
                decision.
              </p>
              <div className="space-y-3 mt-5">
                <Link
                  to="/offline-batch"
                  className="tile-paper p-3 flex items-center justify-between gap-3 text-sm font-semibold"
                >
                  <span className="inline-flex items-center gap-2">
                    <Users className="w-4 h-4" /> Offline in Mehsana
                  </span>
                  <ArrowRight
                    className="w-4 h-4"
                ...
                >
                  <span className="inline-flex items-center gap-2">
                    <Monitor className="w-4 h-4" /> Online support
                  </span>
                  <ArrowRight
                    className="w-4 h-4"
                    style={{ color: "var(--gold)" }}
      ...
      <main className="page-container section-padding space-y-8">
        ...
        <section
          ...
          className="grid lg:grid-cols-[.8fr_1.2fr] gap-6 items-start"
        >
          <div className="card-paper p-5 sm:p-7 md:p-8">
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
            >
              Turn one test paper into an improvement plan
            </h2>
            <p className="leading-7 mt-4" style={{ color: "var(--muted)" }}>
              Bring a recent test paper. Smit Sir will identify the topic,
              answer-writing or practice problem costing marks and explain what
              to fix first.
            </p>
            <ul className="space-y-3 mt-5 text-sm">
              {[
                "No payment for the analysis",
                "No admission commitment",
                "Offline Mehsana and online enquiries welcome",
              ].map((item) => (
                <li
                  key={item}
                  className="tile-paper p-3 flex items-center gap-3"
                >
                  <CheckCircle2
          ...
          <div className="card-paper p-5 sm:p-7 md:p-8">
            <LeadCaptureForm
              compact
              heading="Request your free paper analysis"
              defaults={{
                board: "CBSE",
                classLevel: 12,
                subject: "Economics",
              ...
              landingContextOverride="commerce-coaching-mehsana"
            />
          </div>
        </section>
        ...
        >
          ...
          <h2
            ...
            style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
          >
            Understanding first. Exam application next.
          </h2>
          <p
            className="max-w-3xl leading-7 mb-7"
            style={{ color: "var(--muted)" }}
          >
            The aim is not only to finish chapters. Students should understand
            why a concept works, practise the questions that expose weak areas
            and then revise until they can apply the idea confidently in an
            examination.
          </p>
          ...
          <div
            className="tile-paper p-4 mt-5 text-sm leading-7"
            style={{ color: "var(--muted)" }}
          >
            <strong style={{ color: "var(--ink)" }}>
              Accountancy resources:
            </strong>{" "}
            the website includes free Accountancy calculators and learning tools
            for students. These are separate from Smit Sir&apos;s personal
        ...
        <section className="grid lg:grid-cols-2 gap-6">
          <div className="card-paper p-5 sm:p-7 md:p-9">
            ...
            <h2
              className="text-3xl mt-3 mb-6"
              style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
            >
              A complete path from clarity to practice
            </h2>
              ...
              {advantages.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <CheckCircle2
                    ...
                    style={{ color: "var(--green)" }}
                  />
                  <span className="leading-7" style={{ color: "var(--muted)" }}>
                    {item}
                  </span>
                </li>
              ))}
          ...
          <div className="card-paper p-5 sm:p-7 md:p-9">
            ...
            <h2
              className="text-3xl mt-3 mb-4"
              style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
            >
              Local teaching connected to free digital resources
            </h2>
            <p className="leading-8" style={{ color: "var(--muted)" }}>
              Students in Mehsana can explore offline learning while using the
              same website for chapter notes, practice pages, calculators, tests
              and revision support. Students elsewhere can continue with the
              public learning resources and enquire about online options.
            </p>
            <div className="grid sm:grid-cols-2 gap-3 mt-6">
              <Link
                to="/study-material"
                className="tile-paper p-4 flex items-center justify-between gap-3 font-semibold text-sm"
              >
              ...
              <Link
                ...
                className="tile-paper p-4 flex items-center justify-between gap-3 font-semibold text-sm"
              >
                <span>Commerce calculators</span>
                <ArrowRight
                  className="w-4 h-4"
                  style={{ color: "var(--gold)" }}
                />
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              [
                ...
                "Use the notes, calculators and practice pages to see how concepts are explained.",
              ],
              [
                "2",
                "Bring a test paper",
                "Request a free paper analysis so the weak topic or mistake pattern is identified first.",
              ],
              [
                "3",
                "Choose what fits",
                "Experience the demo and then decide whether online or offline support is useful for you.",
              ],
            ].map(([number, title, text]) => (
              <article key={number} className="tile-paper p-5">
                <span
                  className="w-9 h-9 rounded-full inline-flex items-center justify-center font-bold"
                  style={{ background: "var(--gold-bg)", color: "var(--gold)" }}
                >
                  {number}
                </span>
        ...
        <section className="card-paper p-5 sm:p-7 md:p-9">
          ...
          <h2
            ...
            style={{ fontFamily: "var(--font-serif)", color: "var(--ink)" }}
          >
            Local Commerce routes in Mehsana
          </h2>
          <p className="leading-8 max-w-4xl" style={{ color: "var(--muted)" }}>
            Choose the page that matches your actual need. These pages are
            separated by class, board or subject so students get relevant
            information instead of duplicate local pages.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-6">
            {[
              ...
              [
                ...
                "Free Mehsana Commerce Resources",
              ],
            ].map(([to, label]) => (
              <Link
                key={to}
          ...
          <div
            ...
            style={{ color: "var(--muted)" }}
          >
            <strong style={{ color: "var(--ink)" }}>Local service area:</strong>{" "}
            Mehsana, Gujarat, India ·{" "}
            <strong style={{ color: "var(--ink)" }}>Student support:</strong>{" "}
            <a
          ...
          >
            {faqs.map((faq, index) => (
              <details key={faq.question} className="py-4" open={index === 0}>
                <summary
                  className="cursor-pointer list-none font-semibold flex justify-between gap-4"
                  style={{ color: "var(--ink)" }}
                >
                  {faq.question}
                ...
                <p
                  className="mt-3 leading-7 max-w-4xl"
                  style={{ color: "var(--muted)" }}
                >
                  {faq.answer}
                </p>
        ...
        <section className="card-paper p-6 sm:p-8 md:p-10 text-center">
          ...
          <p
            ...
            style={{ color: "var(--muted)" }}
          >
            Start with a free paper analysis or demo. No admission is required
            just to understand the teaching approach.
          </p>
          <Link
            to={DEMO_PATH}
            className="btn-primary inline-flex items-center gap-2 mt-6"
          >
            Request free analysis + demo <ArrowRight className="w-4 h-4" />
          </Link>
        </section>
      </main>
    </div>
