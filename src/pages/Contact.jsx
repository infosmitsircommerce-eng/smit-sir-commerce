...
export default function Contact() {
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-ivory)' }}>
      <SEO title="Contact — Book Free Demo Class" description="Contact Smit Sir Commerce in Mehsana, Gujarat and send a Class 11 or 12 Commerce admission enquiry." path="/contact" />
      ...
      <div className="page-container section-padding">
        <div className="grid lg:grid-cols-[.78fr_1.22fr] gap-10 items-start">
          <div className="space-y-4 lg:sticky lg:top-28">
            ...
            <div className="card-paper flex items-start gap-4 p-4"><div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'var(--bg-ivory)', border: '1px solid var(--border)' }}><MapPin className="w-5 h-5" style={{ color: 'var(--muted)' }} /></div><div><div className="font-semibold" style={{ color: 'var(--ink)' }}>Location</div><div className="text-sm" style={{ color: 'var(--muted)' }}>Mehsana, Gujarat, India</div></div></div>
