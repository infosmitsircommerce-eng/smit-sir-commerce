...
import { BookOpenCheck, CalendarClock, Loader2, ShieldCheck, UserRoundCog, Users } from 'lucide-react';
...
export default function OwnerHome() {
  ...
  const [stats, setStats] = useState({ students: 0, leads: 0, followups: 0, content: 0 });
  ...
  useEffect(() => {
    ...
    ]).then(([students, leads, followups, content]) => {
      setStats({ students: students.count || 0, leads: leads.count || 0, followups: followups.count || 0, content: content.count || 0 });
      setBusy(false);
    });
  }, [isAdmin]);
