...
const coreItems = [
  ...
  { title: 'Learning Insights', subtitle: 'Unified weak-topic analysis from your practice', path: '/learning-insights', type: 'Progress' },
  ...
  { title: 'My Study Data', subtitle: 'Backup, restore and cloud sync controls', path: '/my-data', type: 'Data' },
];
...
function trackRecent(item) {
  ...
  write(RECENT_KEY, [{ ...item, viewedAt: new Date().toISOString() }, ...current].slice(0, 30));
  window.dispatchEvent(new CustomEvent('ssc-study-state-changed'));
}
