...
export default function SEO({ title, description = DEFAULT_DESCRIPTION, path = '', image = DEFAULT_IMG, noindex = false, type = 'website', structuredData = null, publishedTime = null, modifiedTime = null }) {
  ...
  return (
    <Helmet>
      ...
      <meta property="og:type" content={type} /><meta property="og:site_name" content={SITE} /><meta property="og:locale" content="en_IN" />
