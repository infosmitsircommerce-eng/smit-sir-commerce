...
export default function StatsSection() {
  return (
    <section className="section-padding relative overflow-hidden" style={{ background: 'linear-gradient(180deg, var(--ink-bg) 0%, var(--ink-bg-2) 50%, var(--ink-bg) 100%)' }}>
      ...
      <div className="page-container relative z-10">
        ...
        <div className="grid sm:grid-cols-3 gap-px rounded-2xl overflow-hidden" style={{ background: 'rgba(201,160,80,0.16)', border: '1px solid rgba(201,160,80,0.16)' }}>
          {stats.map((stat) => (
            <div key={stat.label} style={{ background: 'var(--ink-bg)' }}>
        ...
        <div className="mt-12 flex flex-wrap justify-center items-center gap-x-8 gap-y-2 text-xs" style={{ color: 'var(--muted-on-ink)' }}>
