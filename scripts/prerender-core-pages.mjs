...
const pages = [
  ...
  },
  {
    ...
    description: 'Source-backed CBSE and GSEB Commerce quizzes for Class 11 and 12, organised by board, class, subject, chapter and four levels: Easy, Moderate, Hard and Extreme.',
    collection: true,
    body: '<main class="page-container section-padding" data-prerendered="core-page"><article><h1>CBSE & GSEB Commerce quizzes — Class 11 & 12</h1><p>The quiz library is organised in a clear sequence: choose board, class, subject, chapter and then difficulty level. Every published quiz must have real questions behind it and a verified learning source.</p><h2>Four levels in every verified quiz</h2><ul><li><strong>Easy:</strong> definitions and direct recall.</li><li><strong>Moderate:</strong> concept understanding.</li><li><strong>Hard:</strong> application and tricky choices.</li><li><strong>Extreme:</strong> higher-level application.</li></ul><h2>Accuracy before quantity</h2><p>Subjects without a reliable textbook or textbook-based source remain marked as source needed instead of showing fake quiz counts or broken start buttons. Current source-backed starter packs cover CBSE Class 11 Economics, CBSE Class 12 Business Studies and GSEB Class 12 Economics.</p><ul><li><a href="/study-material">Study material</a></li><li><a href="/daily-practice">Daily Commerce practice</a></li><li><a href="/test-series">Commerce test series</a></li><li><a href="/teacher-guides">Teacher Guides</a></li></ul>' + coreNav() + '</article></main>'
  },
  {
    path: '/test-series',
