...
function coreNav() {
  return (
    '<nav aria-label="Explore Smit Sir Commerce"><h2>Continue learning</h2><ul>' +
    '<li><a href="/study-material">Notes & PDFs</a></li>' +
...
const pages = [
  ...
  },
  {
    ...
    collection: true,
    body:
      '<main class="page-container section-padding" data-prerendered="core-page"><article><h1>Commerce courses for Class 11 & 12</h1><p>This course hub is built around the school Commerce topics that are actually published on Smit Sir Commerce. Students can begin with chapter notes, then move into one clear practice desk and useful calculators instead of treating every activity as a separate product.</p><p>For Class 11, the strongest current learning path is Microeconomics, where chapter resources can be used together with concept practice and numerical tools. For Class 12, students can revise Economics and Business Studies through chapter-wise material, exam practice and topic-specific support. The site also includes Entrepreneurship and Physical Education learning support where published.</p><h2>How to use the course hub</h2><p>Choose your class and subject first. Read one chapter resource, close the notes and try to explain the idea in your own words. Then attempt chapter practice. If the mistake is numerical, use the relevant calculator only to verify your method after you have attempted the working yourself. Use timed Exam Mode only when you specifically want exam-condition practice.</p><h2>Start learning now</h2><ul><li><a href="/study-material">Free chapter-wise study material</a></li><li><a href="/cbse-notes">CBSE Commerce notes</a></li><li><a href="/quizzes">Commerce practice</a></li><li><a href="/live-classes">Live-class information</a></li></ul>' +
      coreNav() +
      "</article></main>",
  },
  {
  ...
  },
  {
    ...
    body:
      ...
      '</ol><p><strong>Chapter 8:</strong> Uploading later. It will only be linked after the checked PDF is ready.</p><h2>Your Accountancy Quest</h2><p>Students can mark each available chapter as studied, see their progress and continue automatically from the next unfinished chapter. Progress is saved on the student’s device without requiring an account.</p><h2>Free concept notes and future numerical practice</h2><p>This page contains the Free Simple Explanation collection. Detailed Accountancy numericals will remain clearly separated: Chapters 1 and 2 are planned as free numerical demos, while Chapters 3–10 are planned for the future Premium numerical collection. No unavailable PDF is presented as ready.</p><h2>How to study these chapters</h2><ol><li>Read one concept or format at a time.</li><li>Close the notes and recall the main idea in your own words.</li><li>Match the concept with your current GSEB textbook and school work.</li><li>Attempt written sums separately when numerical practice is available.</li></ol><h2>Frequently asked questions</h2><h3>Are these notes free?</h3><p>Yes. All nine available chapter PDFs can be opened or downloaded without registration.</p><h3>Which chapter is missing?</h3><p>Chapter 8 is still being prepared; every other chapter from 1 to 10 is available.</p><p><a href="/study-material">Browse all study material</a> · <a href="/quizzes">Practise Commerce quizzes</a></p>' +
      coreNav() +
      "</article></main>",
  },
  {
    path: "/quizzes",
    title: "Commerce Practice — Class 11 & 12",
    description:
      "Source-backed Commerce practice for Class 11 and 12, organised by board, class, subject, chapter and four levels: Easy, Moderate, Hard and Extreme.",
    collection: true,
    body:
      '<main class="page-container section-padding" data-prerendered="core-page"><article><h1>Commerce practice — Class 11 & 12</h1><p>Start with Class 11 Microeconomics, Class 12 Macroeconomics or Indian Economic Development. Choose a chapter and difficulty, answer each question and read the explanation.</p><ul><li><a href="/quizzes?subject=micro">Class 11 Microeconomics practice</a></li><li><a href="/quizzes?subject=macro">Class 12 Macroeconomics practice</a></li><li><a href="/quizzes?subject=ied">Indian Economic Development practice</a></li></ul><h2>Four levels in every verified practice pack</h2><ul><li><strong>Easy:</strong> definitions and direct recall.</li><li><strong>Moderate:</strong> concept understanding.</li><li><strong>Hard:</strong> application and tricky choices.</li><li><strong>Extreme:</strong> higher-level application.</li></ul><h2>Full Economics practice banks now published</h2><p>CBSE Class 11 Introductory Microeconomics contains 13 chapter quiz packs with 520 questions. CBSE Class 12 Economics is separated into 5 Introductory Macroeconomics units with 200 questions and 13 Indian Economic Development chapter packs with 520 questions. Each pack has 10 Easy, 10 Moderate, 10 Hard and 10 Extreme questions. Business Studies and GSEB practice remains source-controlled separately.</p><h2>Accuracy before quantity</h2><p>Subjects without a reliable source remain marked as source needed instead of showing fake quiz counts or broken start buttons. An automated quiz audit checks pack IDs, levels, question counts, answer indexes, four-option structure, explanations and source labels before production builds are allowed to deploy.</p><ul><li><a href="/study-material">Study material</a></li><li><a href="/daily-practice">Daily Commerce practice</a></li><li><a href="/teacher-guides">Teacher Guides</a></li></ul>' +
      coreNav() +
      "</article></main>",
  },
  {
    ...
    body:
      ...
      examList +
      '</ul><p><a href="/quizzes">Return to Commerce Practice</a>.</p>' +
      coreNav() +
      "</article></main>",
  },
  {
