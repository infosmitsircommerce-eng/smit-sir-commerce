...
const mainDescription = 'Commerce tuition in Mehsana for Class 11 and 12 with Economics, Business Studies and Entrepreneurship teaching, plus free Commerce notes, Accountancy learning tools, tests, paper analysis and demo-class booking by Smit Sir Commerce.';
const mainFaqs = [
