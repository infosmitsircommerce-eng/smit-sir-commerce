  ...
  return {
    ...
    '@graph': [
      ...
      },
      {
        ...
        knowsAbout: ['Commerce education', 'CBSE Commerce', 'GSEB Economics', 'Class 11 Commerce', 'Class 12 Commerce'],
      },
    ],
  };
}
...
for (const page of pages) {
  ...
  const clean = join(distRoot, `${relative}.html`);
  const directory = join(distRoot, relative, 'index.html');
...
console.log(`Strengthened ${pages.length} AdSense readiness policy/contact pages before audit.`);
