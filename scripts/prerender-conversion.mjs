...
const demoTitle = 'Free Commerce Paper Analysis & Demo | Mehsana';
const demoDescription = 'Free Class 11–12 Commerce paper analysis and demo in Mehsana with a weak-topic plan and no admission pressure.';
await renderPage({
  path: demoPath,
  title: demoTitle,
  ...
  body: `<main class="page-container section-padding" data-prerendered="conversion"><article><p>Mehsana · Class 11 &amp; 12 · Free academic starting point</p><h1>Free Commerce Paper Analysis &amp; Demo in Mehsana</h1><p>Already enrolled in another tuition? You do not need to leave it. Bring your latest test paper, identify where marks are being lost and understand which weak topics need attention before making any admission decision.</p><h2>What students can get</h2><ul><li>Free test-paper and mistake analysis</li><li>Weak-topic action plan</li><li>Free demo class with Smit Sir</li><li>Teaching support in Economics, Business Studies, Entrepreneurship and Physical Education</li></ul><h2>What the paper analysis checks</h2><p>The analysis looks for the actual reason marks are being lost instead of assuming every low score has the same cause. A mistake may come from a concept gap, incomplete revision, a wrong formula, missing Business Studies keywords, weak answer structure, careless calculation or difficulty interpreting a case. Identifying the pattern first makes the next study step more specific.</p><h2>What this free session does not require</h2><p>You do not need to leave an existing tuition, buy a course, promise admission or make a payment to request the free starting analysis. Students can continue using the public notes, quizzes, calculators and practice resources independently even if they decide not to join a batch.</p><h2>My teaching commitment</h2><p>Students who join receive a clear study plan, regular practice, test feedback and honest communication about progress. Results depend on attendance, practice and individual effort, so the website does not promise marks or guaranteed outcomes.</p><p><a href="/contact">Send an enquiry</a> · <a href="/commerce-coaching-mehsana">Commerce tuition in Mehsana</a></p></article></main>`,
});
