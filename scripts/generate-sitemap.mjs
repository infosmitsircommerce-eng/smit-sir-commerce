...
const basePages = [
  ...
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-1-nature-and-significance-of-management-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-2-principles-of-management-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-3-planning-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-4-organizing-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-5-staffing-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-6-directing-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-7-controlling-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-8-financial-management-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-9-financial-market-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-10-marketing-management-notes', 'weekly', '0.92'],
  ['/school-resource/gseb/class-12/business-administration/gseb-class-12-ocm-chapter-11-consumer-protection-notes', 'weekly', '0.92'],
...
const entries = [
  ...
  ...gsebMaterials.map((material) => urlEntry(material.seo_path, 'weekly', '0.88', material.updated || '2026-09-06')),
  ...authorityGuides.map((guide) => urlEntry(guide.path, 'weekly', '0.86', guide.updated)),
  ...toolClusters.map((cluster) => urlEntry(`/tools/topics/${cluster.slug}`, 'weekly', '0.9', '2026-09-03')),
  ...commerceTools
    .filter((tool) => priorityToolSlugs.has(tool.slug))
    .map((tool) => urlEntry(`/tools/${tool.slug}`, 'monthly', '0.82', '2026-09-03')),
  ...localizedPilotPages.map((page) => urlEntry(page.path, 'weekly', '0.82', page.updated)),
];
...
console.log(`Generated focused sitemap with ${uniqueEntries.length} high-value indexable URLs for crawl-budget hygiene.`);
