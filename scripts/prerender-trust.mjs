...
const homeBody = `<main class="page-container section-padding" data-prerendered="trust-home"><article><section style="display:grid;grid-template-columns:1.12fr .88fr;gap:36px;align-items:center"><div><p style="font-weight:800;letter-spacing:.12em;text-transform:uppercase;color:#966313">Smit Sir Commerce</p><h1>In a world chasing marks, choose understanding.</h1><p>Free Commerce notes, PDFs, practice, tools and real-life learning games for Class 11 and 12 students who want clarity first — then marks as the natural result.</p><h2>Learning with Fun. Marks as a Result.</h2><p><a href="/study-material">Open Study Material</a> · <a href="/games">Play Commerce Games</a> · <a href="/cbse-notes">CBSE Notes</a> · <a href="/book-demo">Demo later</a></p></div><figure><img src="/teacher.jpg" alt="Smit Thaker — Commerce Teacher" style="max-width:360px;width:100%;border-radius:24px"><figcaption>Smit Thaker — Commerce teacher focused on clarity, notes and practice.</figcaption></figure></section><section><h2>Start here</h2><ol><li>Choose your board: CBSE or GSEB.</li><li>Pick your class and subject.</li><li>Open chapter notes or download the PDF.</li><li>Practise with questions, tools and realistic Commerce games.</li></ol></section><section><h2>Real Commerce Games</h2><ul><li>Market Shock Simulator — predict demand, supply and price after news.</li><li>Family Budget Challenge — manage income, needs, wants and savings.</li><li>Shopkeeper Price War — decide pricing, discount and stock strategy.</li><li>Inflation Time Machine — understand how money value changes over time.</li><li>Business Decision Game — compare cost, revenue, profit and break-even.</li></ul></section><section><h2>Trust and focus</h2><ul><li>Made by Smit Thaker</li><li>Commerce teacher</li><li>Free material for students</li><li>CBSE and GSEB focused</li><li>Notes first, practice next, demo only when needed</li></ul><p><a href="/ai-discovery.html">AI discovery summary</a> · <a href="/llms.txt">LLMS summary</a></p></section></article></main>`;
...
console.log(`Pre-rendered ${pages.length} trust and policy pages with clean material-first homepage and AI discovery links.`);
