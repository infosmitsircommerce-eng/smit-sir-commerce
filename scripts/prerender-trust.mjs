...
const homeBody = `<main class="page-container section-padding" data-prerendered="trust-home"><article><section><p style="font-weight:800;letter-spacing:.12em;text-transform:uppercase;color:#966313">Smit Sir Commerce</p><h1>Master Commerce with clarity</h1><p>Free Class 11 and 12 Commerce notes, quizzes and exam-focused practice for CBSE and GSEB students — organised so students can move from learning to practice without hunting through scattered files.</p><p><a href="/study-material">Start Free</a> · <a href="/cbse-notes">Explore Notes</a> · <a href="/quizzes">Open Chapter Quizzes</a> · <a href="/board-exam-diagnostic">Board Diagnostic</a></p></section><section><h2>Start your board preparation</h2><ol><li>Choose the correct board, class, subject and chapter.</li><li>Read the free chapter notes or PDF.</li><li>Practise questions and quizzes from the same topic.</li><li>Use exam-focused revision resources to improve the next attempt.</li></ol></section><section><h2>Google search traffic resources</h2><p>These pages help genuine students who search exact phrases like Commerce tuition in Mehsana, GSEB Economics notes PDF, Class 12 Commerce formula sheet, Macroeconomics numericals and Business Studies case-study questions.</p><ul>${trafficHomeLinks}</ul></section><section><h2>Free Commerce practice</h2><ul><li><a href="/board-exam-diagnostic">CBSE and GSEB Class 12 diagnostic tests</a></li><li><a href="/quizzes">Chapter-wise Economics quizzes</a></li><li><a href="/cbse/class-12/business-studies-case-study-questions">Business Studies case-study questions</a></li><li><a href="/study-material">CBSE and GSEB chapter notes</a></li></ul></section><section><h2>Trust and focus</h2><ul><li>Made by Smit Thaker</li><li>Commerce teacher in Mehsana</li><li>Free material for students</li><li>CBSE and GSEB focused</li><li>Notes first, practice next, paid help only when useful</li></ul><p><a href="/ai-discovery.html">AI discovery summary</a> · <a href="/llms.txt">LLMS summary</a></p></section></article></main>`;
